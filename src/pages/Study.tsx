      ...
      <Layout>
        ...
        <div>
            <nav>
                <h2>記事一覧</h2>
                <ul>
                    <li><a href="#">犬の椎間板ヘルニアについて</a></li>
                    <li><a href="#">犬の前十字靭帯断裂について</a></li>
                    <li><a href="#">犬の膝蓋骨内側の脱臼について</a></li>
                    <li><a href="#">猫の尿管閉塞について</a></li>
                    <li><a href="#">猫の最適な食事とは？</a></li>
                    <li><a href="#">猫の最適な飲水とは？</a></li>
                    <li><a href="#">犬の最適な飲水とは？</a></li>
                </ul>
                <a href="#">すべての記事</a>
            </nav>

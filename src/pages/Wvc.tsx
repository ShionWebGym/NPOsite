    ...
    <>
      <Layout>
        ...
        <div>
          <div>
            <p>WVC主催のセミナーとはー</p>
            <h2>2021年「WVC獣医師外科セミナー」のご案内</h2>
            <p>※コロナウイルス感染症の影響により延期・開催日未定</p>
            <p>
              ― WVC（西部獣医会議）継続教育、オクエンドセンターでの実習ラボ ―
              Dr. William Culp 、Dr. Jim Perry、Dr. Ameet
              Singhのセミナー開催概要
            </p>
            <p>※WVC大会開催の日程変更を受けて変更いたします</p>
            ...
            <p>
              ...
              の施設内であるオクエンドセンターで行う、外科の実習セミナーは過去にも私がコーディネートし行って来た経緯がありますが、WVCに参加した獣医師の有志から、兎角海外セミナーに在りがちな利権とならないように、より広く公開し、より進化した形で、セミナーの無駄を省き、より効果的に、獣医師が主体となり誰もが参加しやすい形式で行うことが出来ないかと相談されたのを契機に、私はルビコン川を渡る決意をしました。そして、その方式はNPO方式ならば、公明正大に行えるであろうと考え、発足させたものです。
            </p>
            <p>
              米国のラスベガスで行われるWVC（西部獣医会議）は現在米国で最大規模の獣医師の団体であり、毎年3月に年次大会が行われております。
              また「WVC獣医師外科セミナー」はWVCの継続教育の一環として、日本人獣医師のために、英語での講演の場合は、日本語の通訳付きで行われるものです。
              この施設は獣医学教育（大学を除いて）においては、全米唯一の教育のための専門の組織（ゆえにネバタ州の獣医師免許の試験会場に指定）、ＷＶＣの厳格な動物倫理の基準（安楽死された遺体を使用等）に沿って運営され、且つ獣医学の安全対策に配慮して運営されています。
            </p>
            <p>
              企画・運営：特定非営利活動法人
              小動物疾患研究所（理事長小宮山典寛）
              東京都武蔵野市中町2-6-4（三鷹獣医科グループ内）
              電話：0422-54-5181 メール：<span><a href="http://samri.intellectual-japan.com/contact.html">お問い合わせ</a></span>
            </p>
          </div>
        </div>

...
export type NewspostQuery = { allMarkdownRemark: { edges: Array<{ node: { frontmatter?: { title?: string | null, slug?: string | null, date?: any | null } | null } }> } };
...
export type MyQueryQuery = { site?: { siteMetadata?: { title?: string | null, description?: string | null } | null } | null };

export type CreatePagesQueryVariables = Exact<{ [key: string]: never; }>;


export type CreatePagesQuery = { allMarkdownRemark: { nodes: Array<{ frontmatter?: { slug?: string | null } | null }> } };
